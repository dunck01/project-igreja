      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-gray-900">Suas Informa��es</h2>
            {registration.status !== 'cancelled' && (
              ...
              >
                ...
                {isEditing ? 'Cancelar Edi��o' : 'Editar'}
              </button>
            )}
          </div>
          ...
          {!isEditing ? (
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Informa��es Adicionais</h3>
                <div className="space-y-3">
                  {registration.dietaryRestrictions && (
                    <div className="flex items-start">
                      <Utensils className="h-4 w-4 mr-2 text-gray-500 mt-0.5" />
                      <div>
                        <span className="font-medium text-gray-700">Restri��es Alimentares:</span>
                  ...
                  {!registration.dietaryRestrictions && !registration.accessibilityNeeds && (
                    <p className="text-gray-500 italic">Nenhuma informa��o adicional fornecida.</p>
                  )}
                </div>
              </div>
            </div>
        ...
        {registration.status !== 'cancelled' && (
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">A��es da Inscri��o</h2>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                onClick={() => window.location.href = `mailto:contato@igreja.com?subject=Informa��es sobre inscri��o ${registration.id}`}
